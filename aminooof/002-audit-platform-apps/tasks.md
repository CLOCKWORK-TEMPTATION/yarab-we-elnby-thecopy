...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\sys.md`

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\research.md`

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\AGENTS.md`

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\`
...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\coverage-registry-contract.md`

و

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\check-execution-contract.md`
...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\layer-review-rubric.md`

وتحديث

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\finding-record-contract.md`
...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\audit-report-contract.md`
...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\quickstart.md`

وإنشاء عقد السياسة في

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\confidence-policy-contract.md`
...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\heterogeneous-scope-rules.md`
...
`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\checklists\execution-readiness.md`

وتسجيل أدلة التشغيل الجاف في

`E:\yarab we elnby\the copy\aminooof\002-audit-platform-apps\contracts\dry-run-evidence.md`
